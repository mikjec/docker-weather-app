...
Obraz na dockerhub: `https://hub.docker.com/repository/docker/mikjecz/weather-app/general`

Obraz cache: `https://hub.docker.com/repository/docker/mikjecz/weather-app-cache/general`
...
```
docker images
docker history mikjecz/weather-app:v1
```
```
...
Obraz jest zgodny z platformami sprzętowymi linux/arm64 oraz linux/amd64


### Drugie budowanie obrazu

Wcześniej widoczny błąd związany z obrazem cache zniknął, co było do przewidzenia oraz można zauważyć znacznie skrócony czas tworzenia obrazu ( 180s vs 10s) co jest skutkiem zastosowania cache w trybie max.

```
mikolaj@fedora:~/Dokumenty/docker-weather-app$ docker buildx build --platform linux/amd64,linux/arm64 --ssh default=~/.ssh/id_ed25519 -t mikjecz/weather-app:v2 --cache-to type=registry,ref=mikjecz/weather-app-cache,mode=max --cache-from type=registry,ref=mikjecz/weather-app-cache --push .
[+] Building 10.8s (36/36) FINISHED                                                                                              docker-container:testbuilder
 => [internal] booting buildkit                                                                                                                          0.9s
 => => starting container buildx_buildkit_testbuilder0                                                                                                   0.9s
 => [internal] load build definition from Dockerfile                                                                                                     0.0s
 => => transferring dockerfile: 846B                                                                                                                     0.0s
 ...
 => => resolve docker.io/docker/dockerfile:1@sha256:2780b5c3bab67f1f76c781860de469442999ed1a0d7992a5efdf2cffc0e3d769                                     0.0s
 => [linux/arm64 internal] load metadata for docker.io/library/alpine:3.19                                                                               0.5s
 => [linux/arm64 internal] load metadata for docker.io/library/golang:1.22-alpine                                                                        0.6s
 => [linux/amd64 internal] load metadata for docker.io/library/alpine:3.19                                                                               0.5s
 => [linux/amd64 internal] load metadata for docker.io/library/golang:1.22-alpine                                                                        0.6s
 => [auth] library/alpine:pull token for registry-1.docker.io                                                                                            0.0s
 => [auth] library/golang:pull token for registry-1.docker.io                                                                                            0.0s
 => [internal] load .dockerignore                                                                                                                        0.0s
 => => transferring context: 2B                                                                                                                          0.0s
 => importing cache manifest from mikjecz/weather-app-cache                                                                                              1.8s
 => => inferred cache manifest type: application/vnd.oci.image.manifest.v1+json                                                                          0.0s
 => [linux/amd64 stage-1 1/3] FROM docker.io/library/alpine:3.19@sha256:6baf43584bcb78f2e5847d1de515f23499913ac9f12bdf834811a3145eb11ca1                 0.1s
 => => resolve docker.io/library/alpine:3.19@sha256:6baf43584bcb78f2e5847d1de515f23499913ac9f12bdf834811a3145eb11ca1                                     0.1s
 => [linux/amd64 builder 1/6] FROM docker.io/library/golang:1.22-alpine@sha256:1699c10032ca2582ec89a24a1312d986a3f094aed3d5c1147b19880afe40e052          0.1s
 => => resolve docker.io/library/golang:1.22-alpine@sha256:1699c10032ca2582ec89a24a1312d986a3f094aed3d5c1147b19880afe40e052                              0.1s
 => [linux/arm64 builder 1/6] FROM docker.io/library/golang:1.22-alpine@sha256:1699c10032ca2582ec89a24a1312d986a3f094aed3d5c1147b19880afe40e052          0.1s
 => => resolve docker.io/library/golang:1.22-alpine@sha256:1699c10032ca2582ec89a24a1312d986a3f094aed3d5c1147b19880afe40e052                              0.1s
 => [linux/arm64 stage-1 1/3] FROM docker.io/library/alpine:3.19@sha256:6baf43584bcb78f2e5847d1de515f23499913ac9f12bdf834811a3145eb11ca1                 0.1s
 => => resolve docker.io/library/alpine:3.19@sha256:6baf43584bcb78f2e5847d1de515f23499913ac9f12bdf834811a3145eb11ca1                                     0.1s
 => [auth] mikjecz/weather-app-cache:pull token for registry-1.docker.io                                                                                 0.0s
 => CACHED [linux/arm64 stage-1 2/3] WORKDIR /root/                                                                                                      0.0s
 => CACHED [linux/arm64 builder 2/6] RUN apk add --no-cache git openssh-client                                                                           0.0s
 => CACHED [linux/arm64 builder 3/6] RUN mkdir -p -m 0700 ~/.ssh && ssh-keyscan github.com >> ~/.ssh/known_hosts                                         0.0s
 => CACHED [linux/arm64 builder 4/6] WORKDIR /app                                                                                                        0.0s
 => CACHED [linux/arm64 builder 5/6] RUN --mount=type=ssh git clone git@github.com:mikjec/docker-weather-app.git .                                       0.0s
 => CACHED [linux/arm64 builder 6/6] RUN CGO_ENABLED=0 go build -o weather-app main.go                                                                   0.0s
 => CACHED [linux/arm64 stage-1 3/3] COPY --from=builder /app/weather-app .                                                                              0.0s
 => CACHED [linux/amd64 stage-1 2/3] WORKDIR /root/                                                                                                      0.0s
 => CACHED [linux/amd64 builder 2/6] RUN apk add --no-cache git openssh-client                                                                           0.0s
 => CACHED [linux/amd64 builder 3/6] RUN mkdir -p -m 0700 ~/.ssh && ssh-keyscan github.com >> ~/.ssh/known_hosts                                         0.0s
 => CACHED [linux/amd64 builder 4/6] WORKDIR /app                                                                                                        0.0s
 ...
 => => exporting manifest sha256:58dee153c557fd7b425166f93d78b067868e9c03a768cbbd0b0814bac47328a0                                                        0.0s
 => => exporting config sha256:2bc0086a825f0096525ad4d24a5d59e6809e698010d953ef680abe512c0fd526                                                          0.0s
 => => exporting attestation manifest sha256:e82fc15b0691496cdb0876248d69baea75d907b5fd56edaee679e294d1b43614                                            0.0s
 => => exporting manifest sha256:d74b1533c262db8e9e170f2791a4aff41dc1b9e49d23352b63b58eff52152db9                                                        0.0s
 => => exporting config sha256:783ecdc0418ccf4ae1f9b9324d795fce4c060c468f50485125673a98c39a7afd                                                          0.0s
 => => exporting attestation manifest sha256:e2138b5837bce397dfcacd4f87cd4fc5d879f0fa76ee6baa4099d9c4026c4ebe                                            0.0s
 => => exporting manifest list sha256:b5b09e8e263c03404551c17e70065faae5d23cd5cf14d8c3e3e0ba861790a145                                                   0.0s
 => => pushing layers                                                                                                                                    1.6s
 => => pushing manifest for docker.io/mikjecz/weather-app:v2@sha256:b5b09e8e263c03404551c17e70065faae5d23cd5cf14d8c3e3e0ba861790a145                     3.7s
 => exporting cache to registry                                                                                                                          1.9s
 => => preparing build cache for export                                                                                                                  0.5s
 => => sending cache export                                                                                                                              1.4s
 => => writing layer sha256:26530716c789b6455341a98d56b48aed116bf4af4a1b78b5827e8687f023ff76                                                             0.5s
 => => writing layer sha256:1f3e46996e2966e4faa5846e56e76e3748b7315e2ded61476c24403d592134f0                                                             0.5s
 => => writing layer sha256:17a39c0ba978cc27001e9c56a480f98106e1ab74bd56eb302f9fd4cf758ea43f                                                             0.4s
 => => writing layer sha256:1f486b9ab9ec9f853bb54ebd9d46fdc6460018619035d6886f2b89ede0cbb4c2                                                             0.4s
 => => writing layer sha256:2d88d4855e1f4a40e4e5c3ee18994f26fc968c58ff273829c3d3f31ca4aa63c6                                                             0.1s
 => => writing layer sha256:4861bab1ea04dbb3dd5482b1705d41beefe250163e513588e8a7529ed76d351c                                                             0.1s
 => => writing layer sha256:4b529a1a428d25a73b0af951fb36bcacd86e749d85ad0e2218abf97f46788167                                                             0.1s
 => => writing layer sha256:4d75fd4b73869ed224045c010cdec78756eefb6752a5a8e4804294009eac11e9                                                             0.1s
 => => writing layer sha256:4dd2b198310cf833fc366417834d87f73752ebfc0e0a09ee43602c8355713181                                                             0.1s
 => => writing layer sha256:4f4fb700ef54461cfa02571ae0db9a0dc1e0cdb5577484a6d75e68dc38e8acc1                                                             0.0s
 => => writing layer sha256:52f827f723504aa3325bb5a54247f0dc4b92bb72569525bc951532c4ef679bd4                                                             0.1s
 => => writing layer sha256:5711127a7748d32f5a69380c27daf1382f2c6674ea7a60d2a3e338818590fea1                                                             0.1s
 => => writing layer sha256:59607db92610efd514d91db4096c72a160bfa2e9374c25ae3df16e94f7b5971e                                                             0.1s
 => => writing layer sha256:5f837c998576dcb54bc285997f33fcc2166dff6aa48fe3a374da92474efd5fe8                                                             0.1s
 => => writing layer sha256:90fc70e12d60da9fe07466871c454610a4e5c1031087182e69b164f64aacd1c4                                                             0.1s
 => => writing layer sha256:95eec11c4fc7f2dabd2c3ed156f4875cca606978551d3acb65fcd0116448e03c                                                             0.1s
 => => writing layer sha256:afa154b433c7f72db064d19e1bcfa84ee196ad29120328f6bdb2c5fbd7b8eeac                                                             0.1s
 => => writing layer sha256:bab3f3ebb351851333623db366a48c5b59ce0a2b87dc471f29ecfd659874d19a                                                             0.1s
 => => writing layer sha256:e5b6e5c262c1cb6b4a4de570bd4772f8c346d92b0fa5b1057b74c25fb25a8d62                                                             0.1s
 => => writing layer sha256:f779f57ff09fb5f7c3d6eaba6ea2e903ec6dd588b8493856e2b2354791761746                                                             0.1s
 => => writing layer sha256:fa1868c9f11e67c6a569d83fd91d32a555c8f736e46d134152ae38157607d910                                                             0.1s
 => => writing layer sha256:fa9c872e230520c682f3271480d4c7f844bc1ee320888994b34b3824fc11ec19                                                             0.1s
 => => writing layer sha256:fb661ee02ef12d737bd2840abf2133d5d16f8a40935a47c83da7b514d755ab83                                                             0.1s
 => => writing config sha256:61503e1a9c019121d2af5038dfe459fa135194c5f2a66e97993d6435dfac855e                                                            0.1s
 => => writing cache image manifest sha256:9732586554b1f4ef0b34e292705162aaa3b85301704903966f51d19bd7811751                                              0.2s
 => [auth] mikjecz/weather-app:pull,push token for registry-1.docker.io                                                                                  0.0s
 => [auth] mikjecz/weather-app-cache:pull,push token for registry-1.docker.io                           
 ```


### Sprawdzenie wieloplatformowości

```
docker buildx imagetools inspect mikjecz/weather-app:v1
```
...
Obraz został sprawdzony narzędziem Docker Scout. Zastosowanie nowszych obrazów bazowych (Alpine 3.23 oraz Golang 1.25.10) w wersji v2.1 obrazu, pozwoliło na całkowite wyeliminowanie podatności o statusie HIGH oraz CRITICAL.

```
mikolaj@fedora:~/Dokumenty/docker-weather-app$ docker scout cves mikjecz/weather-app:v2.1
    i New version 1.20.4 available (installed version is 1.15.1) at https://github.com/docker/scout-cli
    ✓ Pulled
...
## Overview
                    ...
                    │       Analyzed Image         
────────────────────┼──────────────────────────────
  Target            │  mikjecz/weather-app:v2.1    
    digest          │  31a5991bdfa0                
    platform        │ linux/amd64                  
...
What's next:
    View base image update recommendations → docker scout recommendations mikjecz/weather-app:v2.1

mikolaj@fedora:~/Dokumenty/docker-weather-app$ 

```

#### Dockerfile po zmianie wersji i wyeliminowaniu błędów
